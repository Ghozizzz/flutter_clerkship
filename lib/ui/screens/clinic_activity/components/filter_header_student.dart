...
import 'package:clerkship/ui/screens/clinic_activity/providers/item_list_waiting_provider.dart';
...
class _FilterHeaderStudentState extends State<FilterHeaderStudent> {
  ...
  void refreshData(BuildContext context) {
    context
        ...
        .getListClinic(idActivity: activityFilterController.selected?.value);
    context
    ...
    context
        ...
        .getListClinic(idActivity: activityFilterController.selected?.value);
    context
        .read<ItemListWaitingClinicProvider>()
        .getListClinic(idActivity: activityFilterController.selected?.value);
  }
}
