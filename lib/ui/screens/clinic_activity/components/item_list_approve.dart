...
class ListItemApproveClinic extends StatelessWidget {
  const ListItemApproveClinic({super.key});

  @override
  Widget build(BuildContext context) {
    final listAllClinic =
        context.watch<ItemListApproveClinicProvider>().listClinic;
    final loading = context.watch<ItemListApproveClinicProvider>().loading;
