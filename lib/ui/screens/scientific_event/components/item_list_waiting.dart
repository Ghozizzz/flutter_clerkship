...
import '../providers/item_list_waiting_provider.dart';

class ListItemWaitingScientific extends StatelessWidget {
  const ListItemWaitingScientific({super.key});

  @override
  Widget build(BuildContext context) {
    final listAllScientific =
        context.watch<ItemListWaitingScientificProvider>().listScientific;
    final loading = context.watch<ItemListWaitingScientificProvider>().loading;
